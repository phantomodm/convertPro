...
module.exports = {
  content: [
    ...
    './snippets/**/*.liquid',
    './layout/**/*.liquid',
    './assets/**/*.js', // If you have JS that adds Tailwind classes
  ],
  extends: {
    // Add any Tailwind plugins here, like @tailwindcss/typography
    overflow: {
      hidden: 'hidden', // Add if doesn't already exist
    },
  },
  theme: {
    screens: {
    ...
    extend: {
      ...
      colors: {
        ...
        colors: {
          ...
          'background-gradient': 'var(--tw-color-background-gradient)', //  gradient
